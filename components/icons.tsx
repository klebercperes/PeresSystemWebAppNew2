...
export const PeresSystemsLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 320 70" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
        {/* Icon based on user-provided image */}
        <g stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round">
            {/* The three nodes of the icon */}
            <circle cx="28" cy="11" r="9" fill="currentColor" stroke="none" />
            <circle cx="11" cy="41" r="9" fill="currentColor" stroke="none" />
            <circle cx="45" cy="41" r="9" fill="currentColor" stroke="none" />
            
            {/* The connectors */}
            <line x1="28" y1="11" x2="11" y2="41" />
            <line x1="28" y1="11" x2="45" y2="41" />
        </g>
        
        {/* Text Elements */}
        <text x="70" y="28" fontSize="28" fontWeight="bold" fontFamily="sans-serif" fill="currentColor">PERES</text>
        <text x="70" y="58" fontSize="28" fontWeight="bold" fontFamily="sans-serif" fill="currentColor">Systems</text>
        <text x="205" y="58" fontSize="11" fontWeight="500" fontFamily="sans-serif" letterSpacing="0.5" fill="currentColor">SMART IT SOLUTIONS</text>
    </svg>
);
...
export const TicketsIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 3v18h18V3H3zm15 2v10H6V5h12zm-3 4H9v2h6V9z"></path></svg>
);
...
export const AiAssistantIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 8V4H8"></path><rect x="4" y="12" width="16" height="8" rx="2"></rect><path d="M12 12v-2a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v2"></path><path d="M4 12v-2a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v2"></path></svg>
);
...
export const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 48 48" {...props}><path fill="#FFC107" d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4C12.955 4 4 12.955 4 24s8.955 20 20 20s20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z"></path><path fill="#FF3D00" d="M6.306 14.691l6.571 4.819C14.655 15.108 18.961 12 24 12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4C16.318 4 9.656 8.337 6.306 14.691z"></path><path fill="#4CAF50" d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.211 35.091 26.715 36 24 36c-5.223 0-9.641-3.657-11.28-8.581l-6.522 5.025C9.505 39.556 16.227 44 24 44z"></path><path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.571l6.19 5.238C44.599 36.338 48 30.651 48 24c0-1.341-.138-2.65-.389-3.917z"></path></svg>
);
...
export const WhatsAppIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.894 11.892-1.99 0-3.903-.52-5.586-1.459l-6.354 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 4.315 1.731 6.086l.169.278-1.005 3.655 3.742-1.001.265.166zm9.355-5.972c-.273-.136-1.612-.799-1.861-.891-.248-.092-.429-.136-.61.136-.181.272-.703.891-.861 1.072-.158.182-.317.205-.589.068-.273-.136-1.146-.42-2.181-1.346-.805-.719-1.346-1.612-1.5-1.891-.153-.272-.014-.42.122-.557.121-.122.273-.318.41-.465.137-.147.182-.248.273-.42.091-.171.045-.317-.023-.454-.068-.136-.61-.84-.834-1.142-.224-.302-.449-.258-.61-.264-.16-.006-.341-.014-.523-.014-.182 0-.477.068-.723.341-.247.272-.94.914-.94 2.225s.964 2.583 1.101 2.765c.137.182 1.891 2.906 4.591 4.043.64.273 1.145.435 1.546.557.653.194 1.255.164 1.724.1.5-.068 1.612-.653 1.846-1.284.234-.631.234-1.168.164-1.284-.069-.116-.247-.182-.522-.318z"/>
    </svg>
);
